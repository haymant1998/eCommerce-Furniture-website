  ...
  <div class="limiter">
    ...
    <form action="checkout.php" method="post">
      ...
      <table width="750" align="center">
        <tr align="center">
            <td colspan="4"><h1>Login or Register </h1><hr></td>
          </tr>
        <tr>
      <td align="right"></td><td><div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
      ...
      <tr>
      <td align="right"></td><td><div class="wrap-input100 validate-input" data-validate = "Password is required">
    ...
    if(isset($_GET['forgot_pass'])){
      echo "
        <div align='center'>
          ...
          <input type='submit' name='forgot_pass' value='Send me Password'/></form>
        </div>
      ";
      if(isset($_POST['forgot_pass'])){
        ...
        if($check_c==0){
          ...
          $message="
            <html>
              <h3>Dear $c_name,</h3>
              <p>You requested for your password at www.localhost.com</p>
              <b>Your Password is </b> <span style='color:red;'>$c_pass</span>
              <h3>Thank you for using our website.</h3>
            </html>
          ";
          //default function to send mail with the given parameters.
