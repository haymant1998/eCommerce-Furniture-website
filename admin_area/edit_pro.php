...
//Getting specific products from table
...
<body bgcolor="grey">
  ...
  <form method="post" action="" enctype="multipart/form-data">
    <table width="794" align="center" border="1" bgcolor="sky-blue">
      <tr align="center">
        <td colspan="2"><h2 style="font-size:25px;">Update or Edit Product</h2></td>
      </tr>
      <tr>
...
if(isset($_POST['update_product']))
{
  ...
  if($product_title=='' OR $product_cat=='' OR $product_brand=='' OR $product_desc=='' OR $product_keywords=='' OR $product_price=='' OR $product_keywords=='')
  {
